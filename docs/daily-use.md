...
3. Run `pnpm scan`. The global lock prevents overlapping normal or provider scans. Spotify daily discovery checks page one and does not claim full catalog coverage.
