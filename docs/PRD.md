...
TS New Music Radar is a private, single-user, non-commercial release tracker. It maintains a provider-neutral watchlist, scans Spotify and MusicBrainz, preserves evidence, and presents one chronological feed. MockProvider supports local development and automated tests.
